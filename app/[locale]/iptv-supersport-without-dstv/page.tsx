// app/[locale]/iptv-supersport-without-dstv/page.tsx
// Pillar — targets "supersport iptv" (4.4k vol, KD 30) + "iptv dstv premiership streaming" (2.9k).
...
const SLUG = "iptv-supersport-without-dstv";
...
export default async function IptvSuperSportPage({ params }: Props) {
  const { locale } = await params;
