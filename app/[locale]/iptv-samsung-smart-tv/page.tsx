// app/[locale]/iptv-samsung-smart-tv/page.tsx
// Pillar — targets "iptv smart tv samsung sa" (2.9k vol, KD 26).
...
const SLUG = "iptv-samsung-smart-tv";
...
export default async function IptvSamsungPage({ params }: Props) {
  const { locale } = await params;
