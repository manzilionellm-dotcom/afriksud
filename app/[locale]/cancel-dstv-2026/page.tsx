// app/[locale]/cancel-dstv-2026/page.tsx
// Pillar — captures churning DStv subscribers at decision moment.
...
export default async function CancelDstvPage({ params }: Props) {
  const { locale } = await params;
