// app/[locale]/iptv-vumatel-openserve-frogfoot/page.tsx
// Pillar — ISP-specific (Vumatel, Openserve, Frogfoot, Octotel, MTN, Vodacom).
...
const SLUG = "iptv-vumatel-openserve-frogfoot";
...
export default async function IptvVumatelPage({ params }: Props) {
  const { locale } = await params;
