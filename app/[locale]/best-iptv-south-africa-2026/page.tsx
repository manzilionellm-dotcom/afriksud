// app/[locale]/best-iptv-south-africa-2026/page.tsx
// Head-term pillar — targets "best iptv south africa" (8.1k vol, KD 42).
...
const SLUG = "best-iptv-south-africa-2026";
...
export default async function BestIptvSAPage({ params }: Props) {
  const { locale } = await params;
