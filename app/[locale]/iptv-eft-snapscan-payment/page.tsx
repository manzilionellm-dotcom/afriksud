// app/[locale]/iptv-eft-snapscan-payment/page.tsx
// Pillar — payment-objection killer (EFT, SnapScan, Ozow, Capitec Pay).
...
const SLUG = "iptv-eft-snapscan-payment";
...
export default async function IptvPaymentPage({ params }: Props) {
  const { locale } = await params;
