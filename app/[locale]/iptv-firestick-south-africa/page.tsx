// app/[locale]/iptv-firestick-south-africa/page.tsx
// Pillar — targets "iptv firestick south africa" + "iptv firestick install south africa" (3.6k + 2.4k vol).
...
const SLUG = "iptv-firestick-south-africa";
...
export default async function IptvFirestickPage({ params }: Props) {
  const { locale } = await params;
