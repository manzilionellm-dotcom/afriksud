...
const COMMERCIAL_LINKS: CommercialLink[] = [
  ...
  { label: "IPTV apps & players (TiviMate, Smarters)", href: "/apps/" },
  { label: "IPTV Help Center — fix buffering & more", href: "/help/" },
  { label: "IPTV Knowledge Base — how it works", href: "/knowledge-base/" },
